...
namespace SiGCT.Data.Business
{
    ...
    public class ServicoBusiness : GenericBusiness<long, Servico, ServicoDAO>
    {
        ...
        internal Servico Parse(string[] array, Conta conta)
        {
            ...
            servico.OperadoraRoaming = array[11];
            ...
            servico.NotaFiscal = Tools.IsNullOrEmpty(array[22]) ? null 
                                                                : new NotaFiscalBusiness().SaveAndReturn(numero: array[22], 
                                                                                                         tipo: (TipoNfEnum)int.Parse(array[21]) 
                                                                                                        );
